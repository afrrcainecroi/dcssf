...
#undef yyFlexLexer
#define yyFlexLexer VaParser_FlexLexer // the trick with prefix; no namespace here :(
#include <FlexLexer.h>
#endif
...
#undef YY_DECL
#define YY_DECL VaParser::Parser::symbol_type VaParser::Scanner::get_next_token()

#include "va_parser.hpp" // this is needed for symbol_type
...
public:
    ...
    virtual ~Scanner() {}
    virtual VaParser::Parser::symbol_type get_next_token();
